...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais que representa un atleta (MODIFICACIÓN 1)");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**Le pide al usuario el nombre de un atleta y luego le muestra a que pais representa este
	 * MODIFICACIÓN 1 (HECHA)
	 **/
	private void ejecutarPaisDeAtleta()
	{
		...
		if (pais != null)
		{
		System.out.println("\n" + "El atleta " + nombre + " representa a " + pais);
		}
		else
		{
			System.out.println("\n" + "No se encontro la información buscada.");
			System.out.println("verifique la entrada y vuelva a intentarlo.");
		}
