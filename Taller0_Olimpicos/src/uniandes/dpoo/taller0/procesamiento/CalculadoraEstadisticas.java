...
public class CalculadoraEstadisticas
{
	...
	/** 
	 * Consulta cual es el pais que representa un atleta especifico.
	 * MODIFICACIÓN 1 (HECHA)
	 * @return un string con el pais que representa el atleta solicitado.
	 **/
	...
	{	
		...
		for (Atleta unAtleta : atletas)
		{
			String ElNombre = unAtleta.darNombre();
			if (ElNombre.equals(nombreAtleta))
			{
				Pais SuPais = unAtleta.darPais();
				ElPais = SuPais.darNombre();
			}
		}
		return ElPais;
	}
